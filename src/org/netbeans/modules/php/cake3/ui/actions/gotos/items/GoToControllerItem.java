...
public class GoToControllerItem extends GoToDefaultItem {
    ...
    public GoToControllerItem(FileObject fileObject, int offset, String baseName) {
        super(fileObject, offset, baseName);
    }

    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon(CakePHP3Constants.GOTO_CONTROLLER_ICON, true);
    }
