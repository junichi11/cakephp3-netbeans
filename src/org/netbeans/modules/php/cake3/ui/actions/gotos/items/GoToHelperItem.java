...
class GoToHelperItem extends GoToDefaultItem {

    public GoToHelperItem(FileObject fileObject, int offset) {
        super(fileObject, offset);
    }

    public GoToHelperItem(FileObject fileObject, int offset, String baseName) {
        super(fileObject, offset, baseName);
    }

    @Override
    public Icon getIcon() {
        return ImageUtilities.loadImageIcon(CakePHP3Constants.GOTO_HELPER_ICON, true);
    }
